...
- This site is in its infancy and under development, for the most in English but some minor parts of it is in Norwegian at the moment for courses tutoring in **Fluid Art** at [tegenskole.no](http://www.tegneskole.no/) <br> 
- The rest is a combination of experience, educations and projects in the realm of Art, Applied Behavioral Analysis, Data Science and Computational Science with Applied Mathematics, Mechanics, Numerical Physics, Artificial Intelligence and Quantum information. 
- As I delved deep into the complex world of Quantum Computing, Quantum Computers, and Quantum Machine Learning, I've compiled a significant array of notes, codes, and resources. This compilation forms the core of what I aim to share with readers through a flexible jupyterbook format. This format paves the way for a more instructive, interactive, and visually engaging book, designed to make these subjects more approachable. I've faced the challenges of these complex subjects head-on and hands-on, and my mission is to ease your learning journey, so you won't have to endure the same struggles I did. My ultimate goal is to demystify these intricate subjects for those who are keen to learn, saving them from the hardships I encountered due to the subjects' complexity and difficulty
- In order to fully comprehend and grasp the subject matter, it is important to acknowledge that it is not an easy topic to read or understand. Patience and hard work are crucial to facilitate the maturation of these subjects. To simplify, the more consistently you engage in exercises, read supplementary materials, visualize, create mind maps, employ mnemonic techniques, and utilize all your senses to comprehend and understand, the faster and more deeply you will grasp the concepts.
- If you spot any mistakes, typos, or see any potential for improvement, your feedback would be greatly valued!<br>
...
Finally I want to express my deep gratitude to Delft University and edx for offering some of the most comprehensive and accessible courses in the field of Quantum Computing and Quantum Computer Technology. These resources have played an instrumental role in enabling me to grasp these fascinating yet incredibly complex subjects and this site is highly influenced from the courses they have offered. I highly recommend them to anyone interested in this field.
